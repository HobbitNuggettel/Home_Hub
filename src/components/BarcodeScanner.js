        ...
        <div className="flex items-center justify-between p-6 border-b border-gray-200">
          <div className="flex items-center space-x-3">
            ...
            <div>
              ...
              <p className="text-sm text-gray-500">Scan items for quick inventory entry</p>
            </div>
          </div>
          <button
            onClick={onClose}
            ...
            <div className="space-y-4">
              <div className="bg-green-50 border border-green-200 rounded-lg p-4">
                <div className="flex items-center space-x-3">
                  ...
                  <div>
                    <h3 className="font-medium text-green-800">Code Scanned Successfully!</h3>
                    <p className="text-sm text-green-600 mt-1">Code: {scannedData}</p>
                  </div>
                </div>
              </div>
