      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {features.map((feature, index) => {
            ...
            return (
              <div key={`feature-${feature.title}`} className="bg-white dark:bg-gray-800 rounded-lg shadow-sm p-6 hover:shadow-md transition-shadow">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            {technologies.map((tech, index) => (
              <div key={`tech-${tech.name}`} className="text-center p-4">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        ...
        <div className="space-y-8">
          {roadmap.map((phase, index) => (
            <div key={`roadmap-${phase.phase}`} className="bg-white dark:bg-gray-800 rounded-lg shadow-sm p-6">
              <div className="flex items-center justify-between mb-4">
              ...
              <ul className="space-y-2">
                {phase.items.map((item, itemIndex) => (
                  <li key={`roadmap-item-${phase.phase}-${item}`} className="flex items-center text-gray-600 dark:text-gray-300">
